...
//*********************************************************
// Changelog: 
//   - Added Identifiers for additional features (eg. NOVOS 3 INC,...)
//   - Removed Identifiers which were not used
//   - Changed objectnames for quick access (1-Byte) identifier
//*********************************************************
// Questions or remarks: support@thermokon.de
...
function Decode(fPort, bytes) {
    ...
    // Calcul de VBAT si une mesure de tension a été fournie
    if (tempVBAT !== null) {
